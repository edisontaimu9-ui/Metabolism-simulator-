"""Shared fixtures for metabosim.models.tdee unit tests."""
...
@pytest.fixture
def very_active_female() -> Person:
    """25-year-old female, 165cm, 60kg, very active."""
    return Person(
        sex=Sex.FEMALE,
        age_years=25,
        height_cm=165,
